...
public class TakenDetails2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void DeleteData(final String id){
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                Toast.makeText(TakenDetails2.this, "Taak verwijderd!", Toast.LENGTH_LONG).show();
